...
export class AppCurrencyDirective {
  ...
  constructor(private el: ElementRef<HTMLInputElement>,private  pipe: DecimalPipe) { 
  ...
  @HostListener('blur') formatValue() {
    ...
    this.el.nativeElement.value = this.pipe.transform(this.el.nativeElement.value,'1.2')
  }
