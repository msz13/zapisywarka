...
describe('DateTimeInputComponent', () => {
  ...
  it('show placeholder', ()=>{
    spectator = createHost(`<app-date-time-input [placeholder]="'test'"></app-date-time-input>`)
  ...
  it("show calendar icon without value", ()=>{
    spectator = createHost(`<app-date-time-input [formControl]="date"></app-date-time-input>`)
