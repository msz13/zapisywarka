...
import { NbFormFieldModule, NbInputModule, NbFormFieldComponent, NbThemeModule } from '@nebular/theme';
...
describe('NameInputComponent', () => {
  ...
  const createHost = createHostFactory({
    ...
    imports: [NbThemeModule.forRoot(), NbFormFieldModule, NbInputModule, ReactiveFormsModule]
  });
  ...
  const createCustomHost = createHostFactory({
    ...
    imports: [NbThemeModule.forRoot(), NbFormFieldModule, NbInputModule, ReactiveFormsModule, FormsModule]
  ...
  it('should show evaible length after input first letter', () => {
    const host = createHost(`<app-name-input [maxLength]="60"></app-name-input>`)
    host.focus('input')
  ...
  it('should show zero when type maxlenght text', () => {
      const host = createHost(`<app-name-input [maxLength]="10"></app-name-input>`)
      host.focus('input')
  ...
  it.only('should bind value from form control', ()=> {
      ...
      const host = createCustomHost<CustomHostComponent>(`<app-name-input [(ngModel)]="testName"></app-name-input>`)
  ...
  it.only('should display set value', ()=> {
    ...
    const host = createCustomHost<CustomHostComponent>(`<app-name-input [(ngModel)]="testModel"></app-name-input>`)
