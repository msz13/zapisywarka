import { Directive, ElementRef, HostListener, OnInit, OnDestroy, ComponentRef, ViewContainerRef, ComponentFactoryResolver } from '@angular/core';
...
export class AppControlErrorDirective implements OnInit, OnDestroy {
  ...
  setError() {
    ...
    if(this.control.errors) {
      if(!this.ref) {
        ...
        const factory = this.resolver.resolveComponentFactory(InputErrorsComponent)
  ...
  setupEvents() {
    this.touchObservableEvent = fromEvent(this.vcr.element.nativeElement, 'blur')
  }
